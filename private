# App隐私声明
尊敬的“体能记录”APP用户（以下统称“您”），为了便于您使用“体能记录”APP（以下简称“本应用”），本应用会按照《“体能记录”APP用户隐私政策》(以下简称“本政策”)约定内容，收集、使用、存储和对外提供您的用户信息。
　　本政策适用于“体能记录”产品及服务，包括“体能记录”官网。 “体能记录”APP以及将“体能记录”APP中的部分功能/服务作为第三方服务集成在其他第三方智能硬件、软件或服务中。
　　您在使用我方的产品或服务时，我方需要按照实名制国家法律法规及监管政策的相关要求收集、存储、使用、共享您的信息，以及向您提供服务及提升服务质量，我方希望通过本政策向您说明：在您使用我方的产品或服务时，我方会收集哪些数据、为什么收集这些数据、会利用这些数据做什么以及我方如何保护这些数据。本政策与您所使用的我方的产品或服务息息相关，对于您行使用户权利及保护您的用户信息至关重要，请您在使用我方的产品或服务前认真阅读并充分理解本政策所写明的内容（特别是使用黑体加粗下划线的内容）。
　　请您仔细阅读本政策，并确定理解我方对您用户信息的处理规则。如您有任何疑问，可联系本应用官方服务热线12329进行咨询。如您点击“同意”并确认提交、使用本应用或在我方更新本政策后（我方会及时通知您更新的情况）继续使用本应用，即视为您同意本政策(含更新版本)内容，并且同意我方按照本政策收集、使用、保存和对外提供您的用户信息。
　　特别提示：您通过“体能记录”使用第三方服务时，第三方可能有自己的隐私保护政策。当您查看第三方创建的网页或使用第三方开发的服务时，这些第三方可能会放置他们自己的Cookie或网络Beacon，这些Cookie或网络Beacon不受我们的控制，我们会努力去要求这些主体对您的个人信息采取保护措施，建议您与他们取得联系获得关于他们的隐私政策的详细情况。如您发现这些第三方服务存在风险时，建议您终止相关操作以保护您的合法权益。
　　您可以根据以下索引阅读相应章节，进一步详细了解我方隐私政策的具体约定：
　　一、我方收集和处理您的用户信息的原则
　　二、我方收集和处理您的用户信息的目的
　　三、我方如何收集与使用您的用户信息
　　四、我方如何使用 Cookie 和同类技术
...
　　一、我方收集和处理您的用户信息的原则合法、正当和必要的原则。主要指：
...
　　1.当您在“体能记录”APP上进行注册、管理、实名认证相关必要活动时，您需要提交真实、合法、有效的信息，包括您的姓名、身份证号码、联系电话、人脸生物信息、银行卡号、银行卡类型。
　　2.当您登录本应用时，您需要向我方授权获取或主动输入您的用户名/证件号+手机验证码，同时同意我方对您提供的登录信息进行有效性核验，如您不提供上述信息，我方将无法向您提供服务评价、实名认证、网上办事、公积金提取或其它需登录才可使用的服务。
　　3.当您重置本应用登录密码时，您需要根据选择的重置密码的方式向我方授权获取或主动输入您的真实、合法、有效的信息，包括您的姓名、手机号码、短信验证码信息、人脸生物信息、证件类型、证件号码， 同时同意我方对您提供的有关信息进行有效性核验。
...
　　 5.当您使用本应用中基于位置提供的相关服务时，需要您授权我方使用您的位置信息，包括：
...
　　（三）信息的收集方式
　　1.当您注册成为“体能记录”的用户时：
　　（1）当您成为普通用户时，只需要提供您的 手机号码 注册即可，普通用户可以查阅办事指南，使用一些无需实名认证的基础服务。
　　（2）当您成为实名用户时，我们依据法律法规及监管规定进行实名制管理，成为我们的实名用户，在普通用户基础上提供您的需姓名、身份证号码 或能证明身份的其他证件信息进行实名认证，实名认证方式可以选择刷脸、银行卡认证以及人工服务审核。刷脸认证需要提供您的生物识别（静态、活动态的面部特征），银行卡认证需要提供您的 I类银行账户及银行预留手机号，人工服务审核需要提供您的姓名、身份证号码或能证明身份的其他证件信息，以及手持证件照信息。成为实名用户后，您可以基于您的姓名、身份证号码使用实名才可使用的服务，此类服务包括名下电子证照和卡片信息、政务事项办理进度、公积金信息、。
　　（3）当您仅需要浏览主频道，或使用一些无需登录的服务，您不需要注册成为我们的用户提供以上信息。
　　（4）您可通过（我的-账户与安全）对个人信息做查询及修改。
　　（5）如果您不想继续使用该产品或服务，可通过（我的-设置-账号与安全-注销用户名）在线提交账户注销申请，或致电12329联系客服，协助您注销您的账户。在您主动注销账户之后，我们将停止为您提供产品或服务，根据适用法律的要求删除您的个人信息，或使其匿名化处理。
　　（6）我们通过您主动提交，以及在您使用我们的服务过程中产生相应的记录或其他合法的方式收集您的信息。如果您不提供服务所需的必要信息，可能无法正常使用服务，请您理解。
　　2.在服务使用过程中，我们可能还需要您提供以下必要的系统权限才能完成服务的使用。在您接收系统消息推送时，则需要您允许访问手机通知权限。在您查看基于定位和导航服务的信息则需要您允许访问手机地理位置权限。在您使用语音搜索时，则需要您允许麦克风权限。在您使用在线业务办理时，需要输入相关信息、上传或下载图片，则需要您允许读取手机存储权限、相机权限。在您使用指纹或面容ID登录时，您需在设备上完成信息验证。 我们仅接收验证结果，并不收集您的指纹信息或面容ID信息。如您不想使用指纹或面容ID验证，仍可通过其他方式登录。此外，为了您的个人信息与敏感数据安全，我们做了应用防劫持处理，则需要您允许显示悬浮窗权限。
　　3.除了必要的系统权限，在服务使用过程中，我们还需要您提供业务所需的个人信息才能完成服务的使用，您可以向我们提供，如您选择不提供该信息则无法使用这些服务。包含以下服务或分类：
...
　　 4. 本APP已集成诸多第三方SDK，在您使用服务过程中第三方SDK采集的信息：
　　按照业务要求，我们会内嵌第三方SDK。以下内容为我们向第三方收集的协议生效时第三方SDK采集项说明，内容由SDK所属第三方提供，本文仅作转述 。如您选择不提供所述信息则可能无法使用对应服务。但不影响您使用我们提供的其他服务。请注意，对于第三方SDK采集的信息，由第三方承担保密责任，相关保密政策请参考第三方隐私政策。
　　（1）多源认证SDK：由上海市数字证书认证中心有限公司（简称上海CA）为您提供身份核验服务。完成个人身份校验可能需要您在使用身份信息核验服务过程中提供以下信息：您的真实姓名、身份证/护照等有效身份证明。同时，根据相关规则的认证等级的不同要求，上海CA可能将根据不同认证方式按需收集您的生物识别信息（包括人像、声音、指纹、虹膜、步态等）、电子邮箱、手机号码、银行卡号、银行预留手机号等信息。
　　（2）百度地图SDK：由北京百度网讯科技有限公司提供技术支持，用于公积金业务办理网点的地图定位导航。会采集您的当前地理位置信息(经纬度信息)和您的手机终端唯一标志信息（IMEI号），详细隐私政策可参考https://lbsyun.baidu.com/index.php?title=openprivacy 。
　　（3）腾讯云SDK：由腾讯云计算（北京）有限责任公司提供，该SDK需要获取您的姓名、身份证号码、人脸视频，用于人脸识别功能，需要访问您的相机，麦克风和相册及文件权限。
　　详细隐私政策可参考：https://cloud.tencent.com/document/product/301/11470
　　（4）通讯类SDK :  为了保障您的通讯，我们使用了okhttp SDK，需要使用您的网络权限。
　　（5）图片类SDK.： 为了便于您从本客户端下载并展示图片，我们使用了Bumptech SDK,需要使用您的存储权限和网络权限。
　　（6） PDF文件预览SDK：我们使用了barteksc SDK用于显示PDF文件，需要使用读取文件存储的权限。
　　（7）高德地图SDK： 用于业务办理网点在地图上展现，会使用到地理位置信息。详细隐私政策可参考：https://lbs.amap.com/pages/privacy
　　（8）微信SDK：由深圳市腾讯计算机系统有限公司提供技术支持，用于微信快捷登录，访问微信小程序，用户信息包括：姓名、手机号码、用户设备信息、微信头像、微信昵称。 详细隐私政策可参考：https://privacy.qq.com/policy/sdk-privacypolicy和
https://weixin.qq.com/cgi-bin/readtemplate?t=opensdk_agreement&lang=zh_CN
　　（9）Zxing二维码扫描：是基于google公司的Zxing项目，提供二维码扫描和分析功能，需要您提供相册或拍照功能、网络状态、闪光灯权限。
　　5.在业务要求或交互设计变更时，在必要的情况下，我们会收集关于您使用产品、服务以及使用方式的信息并将这些信息进行关联，这些信息包括：
　　（1）设备信息：为了保障向您提供的服务安全稳定运行，我们需要记录您使用“体能记录”服务的类型、方式及设备型号、IP地址、设备软件版本信息、设备识别码、设备标识符、正在运行的进程信息，应用程序的总体运行，所在地区、网络使用情况。如果您不同意我们记录前述信息，可能无法完成风控验证。
...
　　四、我方如何使用 Cookie 和同类技术
　　如果我们使用Cookie或同类技术手段的话，如您体验我们身份核验服务系统（包括但不限于网站、微信/支付宝小程序、APP），为您获得更轻松的访问体验，我们会在您的计算机或移动设备上存储Cookie、Flash Cookie，或浏览器（或关联应用程序）提供的其他通常包含标识符、站点名称以及一些号码和字符的本地存储（统称“Cookie”）。Cookie 通常包含标识符、站点名称以及一些号码和字符。我们不会在Cookie里面存储个人信息。
...
　　（二）获取个人信息副本
　　若您需要您的个人信息副本，可致电12329联系客服，在核实您的身份后，我们将向您提供您在我们应用中的个人信息副本（包括基本资料、身份信息），但法律法规另有规定或本政策另有约定的除外。
　　（三）改变您授权同意的范围或撤回您的授权
　　您可以通过注销用户名、删除应用中所有用户信息、卸载本应用的方式撤回全部隐私授权，我方将不会再收集、使用或对外提供与该账号相关的个人信息，但您在使用我方服务期间提供或产生的信息，我方仍需按照监管要求的时间进行匿名化保存，且在该依法保存的时间内有权机关仍有权依法查询。
　　您也可以通过在手机操作系统中修改隐私设置的方式或在“我的-设置-通用-授权管理”中撤销您的授权。
　　当您撤回同意或授权后，我方无法继续为您提供撤回同意或授权所对应的便民服务。但您撤回同意或授权的决定，不会影响此前我方基于您的授权而开展的使用、存储和对外提供您用户信息的处理。
...
　　（五）在访问、修改、删除、注销账号的相关信息时，我方可能会要求您进行身份验证并审核合法性，以保障账号安全。请您理解，由于技术所限、基于法律法规要求，您的某些请求可能无法进行响应。基于法律法规要求、保障信息安全等正当事由，您的部分信息可能无法访问、修改和删除。
　　（六）约束信息系统自动决策
...
　　6.涉及商业秘密的；
　　7.为履行反洗钱和制裁规定。
　　如您对上述权利实现存在疑问，可以根据“联系我们”中的相关联系方式与我们取得联系。
　　 八、征得授权同意的例外
...
　　十一、如何联系我方
　　如您对本政策存在任何疑问，或有任何相关的投诉、纠纷、意见进行反馈。我方将尽快受理您的请求，并在验证您的用户身份后的15个工作日内予以回复。
　　 十二、其它
